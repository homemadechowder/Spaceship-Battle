...
#define SERVER_NAME             "a1wfjubhm8nxmw-ats.iot.us-west-2.amazonaws.com"
...
#define HOSTHEADER "Host: a1wfjubhm8nxmw-ats.iot.us-west-2.amazonaws.com\r\n"
...
int http_post(int iTLSSockID, char *message){
    ...
    int dataLength = strlen(DATASTART) + strlen(message) + strlen(DATAEND);
...
{
    //Need to add quotation marks to beginning and end of message
    int len = strlen(message);
    char *msgtosend = malloc(sizeof(char) * (len + 3));
    int i;
    int iretval = 0;
